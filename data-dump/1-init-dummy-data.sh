...
VALUES
(1, 2, 1, pgp_sym_encrypt('Is the bicycle still available?', '${ENCRYPTION_KEY}'), '2023-03-02 10:00:00'),
(2, 1, 2, pgp_sym_encrypt('Can you lower the price for the laptop?', '${ENCRYPTION_KEY}'), '2023-04-02 15:30:00');
